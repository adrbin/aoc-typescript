...
function part1(input) {
    ...
    return (_a = result === null || result === void 0 ? void 0 : result.join('')) !== null && _a !== void 0 ? _a : 'Did not found';
}
...
function solveWs(order = Order.Ascending, z = 0, level = 0, cache = new Map()) {
    if (z < 0 || z > 100000) {
        return undefined;
    }
...
function calculate(w, z, { divConst, addConst, addConst2 }) {
    let x = z % 26;
...
function calculateZ(w, z, { divConst, addConst, addConst2 }) {
...
(0, utils_js_1.runPuzzles)(part1, part2, 2021, 24);
